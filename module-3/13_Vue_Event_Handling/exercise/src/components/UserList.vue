...
export default {
  ...
  methods: {
    enableSelectedUsers() {
      let selected = this.selectedUserIDs;
      let userArray = this.users;
      userArray.forEach((user) => {
        if(selected.includes(user.id) && user.status == "Disabled") {
    ...
    disableSelectedUsers() {
      ...
      let userArray = this.users;
      userArray.forEach((user) => {
        if(selected.includes(user.id) && user.status == "Active") {
