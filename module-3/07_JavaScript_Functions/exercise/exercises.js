 ...
 */
  ...
  function makeNumber(first, second = '') {
      let number = first.concat(second);
 ...
 * @returns the previous array of strings prepended by "Happy "
 */
 ...
 */
    ...
    return arr.map((keys) => {
        return [keys.streetNumber, keys.streetName, keys.streetType, keys.city, keys.state, keys.zip].join(' ');
    });
}
